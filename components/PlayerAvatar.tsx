...
import { Player, Vote, GamePhase, UserType } from '../types';
...
export const PlayerAvatar: React.FC<PlayerAvatarProps> = ({ player, vote, phase }) => {
  const hasVoted = !!vote;
  ...
  return (
    <div className="flex flex-col items-center gap-3 relative group">
      ...
      {/* Reasoning Bubble (Only when revealed and exists) */}
